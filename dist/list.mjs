(function(){"use strict";try{if(typeof document<"u"){var t=document.createElement("style");t.appendChild(document.createTextNode('.cdx-list{margin:0;padding-left:40px;outline:none}.cdx-list__item{padding:5.5px 0 5.5px 5px;line-height:1.6em}.cdx-list--compact .cdx-list__item{padding-top:0!important;padding-bottom:0!important}.cdx-list--ordered{list-style:decimal}.cdx-list--unordered{list-style-type:disc}.cdx-list--circled{list-style-type:circle}.cdx-list--squared{list-style-type:square}.cdx-list--stared{list-style-type:"★"}.cdx-list--dashed{list-style-type:"-"}.cdx-list--arrowed{list-style-type:"→"}.cdx-list-settings{display:flex}.cdx-list-settings .cdx-settings-button{width:50%}[data-item-name=normal] .ce-popover-item__icon,[data-item-name=compact] .ce-popover-item__icon{width:1px;overflow:hidden;opacity:0}')),document.head.appendChild(t)}}catch(e){console.error("vite-plugin-css-injected-by-js",e)}})();
const a = '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><line x1="9" x2="19" y1="7" y2="7" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><line x1="9" x2="19" y1="12" y2="12" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><line x1="9" x2="19" y1="17" y2="17" stroke="currentColor" stroke-linecap="round" stroke-width="2"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M5.00001 17H4.99002"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M5.00001 12H4.99002"/><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M5.00001 7H4.99002"/></svg>', l = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>`, h = `<svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
class w {
   ...
   */
  constructor({ data: e, config: t, api: i, readOnly: n }) {
    this._elements = {
      wrapper: null
    }, this.api = i, this.readOnly = n, this.settings = {
      style: [
        {
          name: "numbered",
          title: this.api.i18n.t("Numbered"),
          icon: l,
          default: t.defaultStyle === "numbered" || !0
        },
        {
          name: "unordered",
        ...
        },
        {
          ...
          icon: h,
          default: t.defaultStyle === "circled" || !1
        },
        {
          name: "squared",
          title: this.api.i18n.t("Squared"),
          icon: d,
          default: t.defaultStyle === "squared" || !1
        },
        {
          name: "stared",
          title: this.api.i18n.t("Stared"),
          icon: c,
          default: t.defaultStyle === "stared" || !1
        },
        {
          name: "dashed",
          title: this.api.i18n.t("Dashed"),
          icon: p,
          default: t.defaultStyle === "dashed" || !1
        },
        {
          name: "arrowed",
          title: this.api.i18n.t("Arrowed"),
          icon: u,
          default: t.defaultStyle === "arrowed" || !1
        }
      ],
      spacing: [
        {
          ...
          icon: null,
          default: t.defaultSpacing === "normal" || !0,
        ...
        },
        {
          ...
          icon: null,
          default: t.defaultSpacing === "compact" || !1
        }
      ]
    }, this._data = {
      style: this.settings.style.find((s) => s.default === !0).name,
      spacing: this.settings.spacing.find((s) => s.default === !0).name,
      items: []
    }, this.data = e;
  }
  /**
   ...
   */
  render() {
    return this._elements.wrapper = this.makeMainTag(
      this._data.style,
      this._data.spacing
    ), this._data.items.length ? this._data.items.forEach((e) => {
   ...
   */
  makeMainTag(e, t) {
    const i = e === "numbered" ? this.CSS.wrapperOrdered : `${this.CSS.wrapperList}${e}`, n = t === "compact" ? this.CSS.spacingCompact : this.CSS.spacingNormal, s = e === "numbered" ? "ol" : "ul";
    return this._make(s, [
      this.CSS.baseBlock,
      this.CSS.wrapper,
      i,
   ...
   */
  toggleSpacingTune(e) {
    const t = this.makeMainTag(this._data.style, e);
    for (; this._elements.wrapper.hasChildNodes(); )
      t.appendChild(this._elements.wrapper.firstChild);
    this._elements.wrapper.replaceWith(t), this._elements.wrapper = t, this._data.spacing = e;
  }
  /**
   * Styles
   *
   ...
   */
  set data(e) {
    e || (e = {}), this._data.style = e.style || this.settings.style.find((i) => i.default === !0).name, this._data.spacing = e.spacing || this.settings.spacing.find((i) => i.default === !0).name, this._data.items = e.items || [];
  ...
  getOutofList(e) {
    ...
    if (t.length < 2)
      return;
    const i = t[t.length - 1], n = this.currentItem;
    n === i && !i.textContent.trim().length && (n.parentElement.removeChild(n), this.api.blocks.insert(), this.api.caret.setToBlock(this.api.blocks.getCurrentBlockIndex()), e.preventDefault(), e.stopPropagation());
  }
  /**
   * Handle backspace
   *
   ...
   */
  backspace(e) {
    const t = this._elements.wrapper.querySelectorAll("." + this.CSS.item), i = t[0];
    i && t.length < 2 && !i.innerHTML.replace("<br>", " ").trim() && e.preventDefault();
  }
  /**
  ...
  selectItem(e) {
    e.preventDefault();
    const t = window.getSelection(), i = t.anchorNode.parentNode, n = i.closest("." + this.CSS.item), s = new Range();
    s.selectNodeContents(n), t.removeAllRanges(), t.addRange(s);
  }
  /**
  ...
  pasteHandler(e) {
    ...
    if (t === "LI")
      ...
      n.items = s.map((r) => r.innerHTML).filter((r) => !!r.trim());
    }
    return n;
  }
}
