...
export default class List {
     ...
     */
    makeMainTag(style: string, spacing: string): HTMLOListElement | HTMLUListElement;
    /**
     * Toggles List style
     *
     * @param {string} style - 'ordered'|'unordered'
     */
    toggleStyleTune(style: string): void;
    /**
     * Toggles List style
     *
     * @param {string} spacing - 'compact'|'normal'
     */
    toggleSpacingTune(spacing: string): void;
    /**
     * Styles
     *
     * @private
